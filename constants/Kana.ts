...
export const hiraganaHandakuten: IKanaPair[] = [
...
export const katakanaDakuten: IKanaPair[] = [
...
export const katakanaHandakuten: IKanaPair[] = [
...
export const katakanaYoon: IKanaPair[] = [
